...
public class ProductWithExhName {
	...
	public String toString() {
		return "ProductWithExhName [prodId=" + prodId + ", exhId=" + exhId + ", exhName=" + exhName + ", prodName="
				+ prodName + ", prodDesc=" + prodDesc + ", prodSpecification=" + prodSpecification + ", prodExperty="
