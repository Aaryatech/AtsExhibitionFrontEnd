...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/mainnew.css">
<!--===============================================================================================-->
</head>
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title"
					style="background-image: url(${pageContext.request.contextPath}/resources/images/exh.jpeg);">
					<span class="login100-form-title-1"> Sign In To ATS
						EXHIBITION </span>
				</div>
				<form class="login100-form validate-form" id="form-login"
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Username</span> <input
							...
							placeholder="Enter username" maxlength="10"> <span
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<div>
							<a href="createNewPassword" class="txt1"> Forgot Password? </a>
						</div>
					</div>
	...
	<!--===============================================================================================-->
	<script
		src="${pageContext.request.contextPath}/resources/js/mainnew.js"></script>
