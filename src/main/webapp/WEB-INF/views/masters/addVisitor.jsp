...
<body>
			...
			<div class="wrapperIn2">
				...
				<div class="sidebarright">
					...
					<form name="frm_search" id="frm_search" method="post"
						action="${pageContext.request.contextPath}/insertVisitor"
						...
						<div class="colOuter">
							...
							<div class="col-md-3">
								<input id="custName" class="form-control"
									placeholder="Visitor Name" value="${customer.custName}"
									style="text-align: left;" name="visitorName" type="text"
									required> <input id="empId" class="form-control"
						...
						<div class="colOuter">
							...
							<div class="col-md-2">
								<div class="col1title" align="left">Select Company Type*:
								</div>
							</div>
						...
						<div class="colOuter">
							<div align="center">
								<input name="submit" class="buttonsaveorder" value="Submit"
									type="submit" align="center" id="submitButton"> <input
	...
	<script>
		function clearText() {
			window.open(
					'${pageContext.request.contextPath}/addVisitorByExhibitor',
					'_self');
			//window.close();
		}
	</script>
