	...
	<div class="fullGrid center">
		...
		<div class="wrapperIn2">
			...
			<div class="sidebarright">
				...
				<form name="frm_search" id="frm_search" method="post" action="${pageContext.request.contextPath}/insertEnquiry"
				enctype="multipart/form-data"> 
					 
						<div class="col-md -3">
							
								<div class="col1title" align="left"><h3>Add Enquiry</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-2">
						<select class="selectpicker" onchange="getEmpByEventId();" data-live-search="true"  title="Please Select" 
						...
						<select class="selectpicker" data-live-search="true"  title="Please Select" 
															name="visitorId" id="visitorId"  required> 
					...
					<div class="colOuter">
						...
						<div class="col-md-2"> </div> 
						<div class="col-md-2">
							<div class="col1title" align="left">Select Next Meet Date*: </div>
						</div>
