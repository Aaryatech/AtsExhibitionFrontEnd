	...
	<div class="fullGrid center">
		...
		<div class="wrapperIn2">
			...
			<div class="sidebarright">
				...
				<form name="frm_search" id="frm_search" method="post" action="${pageContext.request.contextPath}/insertMaterial"
				enctype="multipart/form-data"> 
					 
						<div class="col-md -3">
							
								<div class="col1title" align="left"><h3> Material Detail</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-3">
							<input id="matName" class="form-control"
								placeholder="Employee Name" value="${matDetail.matName}" style="text-align: left;" name="matName" type="text" disabled>
