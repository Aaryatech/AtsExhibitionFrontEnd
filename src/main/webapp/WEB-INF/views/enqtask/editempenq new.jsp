		...
		<div class="fullGrid center">
			...
			<div class="wrapperIn2">
				...
				<div class="wrap">
					...
					<div>
					<p style="text-align: center; color: red;">Edit
									Enquiry List</p>
					</div>
					<div class="fleft">
						<c:forEach items="${enqList}" var="enquiry" varStatus="count">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<b>Email Id:</b> ${enquiry.visitorEmail}&nbsp;&nbsp;<b>Approximate
										Time:</b> ${enquiry.approximateTime}
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">
									<b> Meeting Date:</b> <input class="datepicker"
										...
										value="${enquiry.nextMeetDate}" style="text-align: center;"
							...
							<input type="button" value="Edit Enquiry" class="buttonsaveorder"
					...
					<%-- <div class="fright">
						<div>
							<strong><u><p
										style="text-align: center; color: green;">Task List</p></strong></u>
						</div>
						<c:set var="status" value="null"></c:set>
						...
						<c:forEach items="${taskList}" var="tasks">
							...
							<p>
								<b>Employee:</b> ${tasks.empName} &nbsp;&nbsp;<b>Date:</b>
								${tasks.date}
							</p>
							<p>
								<b>Task Desc: </b>${tasks.taskDesc}&nbsp;&nbsp;<b>Status:</b>
								${status}
							</p>
							<hr />
						</c:forEach>
 ...
 --%>
	...
	function editEnquiryAction(enqId,indexee) {
		...
		// alert("Employee Id " +empId);
		    ...
		    window.open('${pageContext.request.contextPath}/editEmpEnquiry/'+empId+'/'+enqId+'/'+meetDate);
		    //form.submit();
