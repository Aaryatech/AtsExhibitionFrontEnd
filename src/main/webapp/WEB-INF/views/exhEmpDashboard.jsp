...
<body>
 ...
 --%>
							<div class="col-md-1" align="left">Select Employee*:</div>


							<div class="col-md-2">
								<select title="Please Select" name="empId" id="empId"
									class="form-control" required>

									<c:forEach items="${empList}" var="empList">
										<c:choose>
											<c:when test="${empList.empId==editEmp.empId}">
						...
						<div class="colOuter">
							...
							<div class="col-md-3">
								<a href="${pageContext.request.contextPath}/enquiryExhList/1">
									<div class="layers bd bgc-white2 p-20"
										style="background: url(${pageContext.request.contextPath}/resources/images/a1.jpg); background-position: center; ">
										<div class="layer w-100 mB-10">
											<h6 class="lh-1">Total Pending Enquiry</h6>
										</div>
										<div class="layer w-100">
											<div class="peers ai-sb fxw-nw">
												<div class="peer peer-greed">
													<span id="sparklinedash"><canvas width="45"
															height="20"
															style="display: inline-block; width: 45px; height: 20px; vertical-align: top;"></canvas></span>
												</div>
												<div class="peer">
													<span
														class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">0${pending.size()}</span>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-3">
								<a href="${pageContext.request.contextPath}/enquiryExhList/2">
									<div class="layers bd bgc-white2 p-20"
										style="background: url(${pageContext.request.contextPath}/resources/images/a8.jpeg); background-position: center; ">
										<div class="layer w-100 mB-10">
											<h6 class="lh-1">Total Processing Enquiry</h6>
										</div>
										<div class="layer w-100">
											<div class="peers ai-sb fxw-nw">
												<div class="peer peer-greed">
												...
												<div class="peer">
													<span
														class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">0${processing.size()}</span>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-3">
								<a href="${pageContext.request.contextPath}/enquiryExhList/4">
									<div class="layers bd bgc-white2 p-20"
										style="background: url(${pageContext.request.contextPath}/resources/images/a3.png); background-position: center; ">
										<div class="layer w-100 mB-10">
											<h6 class="lh-1">Total Closed Enquiry</h6>
										</div>
										<div class="layer w-100">
											<div class="peers ai-sb fxw-nw">
												<div class="peer peer-greed">
												...
												<div class="peer">
													<span
														class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">0${closed.size()}</span>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-3">
								<a href="${pageContext.request.contextPath}/enquiryExhList/5">
									<div class="layers bd bgc-white2 p-20"
										style="background: url(${pageContext.request.contextPath}/resources/images/a5.jpeg); background-position: center; ">
										<div class="layer w-100 mB-10">
											<h6 class="lh-1">Total Completed Enquiry</h6>
										</div>
										<div class="layer w-100">
											<div class="peers ai-sb fxw-nw">
												<div class="peer peer-greed">
												...
												<div class="peer">
													<span
														class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">0${completed.size()}</span>
												</div>
											</div>
										</div>
									</div>
