			...
			<div class="wrapperIn2">
				...
				<div class="sidebarright">
					...
					<form name="frm_search" id="frm_search" method="post"
						action="${pageContext.request.contextPath}/getTotalList"
 ...
 -->
						...
						<div class="colOuter">
							...
							<div class="col-md-2">
								<h3>
									<a
										href="${pageContext.request.contextPath}/showEnquiryBetweenDates">
							...
							<div class="col-md-2">
								<h3>
									<a href="${pageContext.request.contextPath}/enquiryList/1">
							...
							<div class="col-md-2">
								<h3>
									<a href="${pageContext.request.contextPath}/enquiryList/2">
						...
						<div class="colOuter">
							...
							<div class="col-md-2">
								<h3>
									<a href="${pageContext.request.contextPath}/enquiryList/5">
