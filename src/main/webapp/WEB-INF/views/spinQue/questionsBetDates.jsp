						...
						<table id="table_grid" class="main-table">
							...
							<thead>
								<tr class="bgpink">
									...
									<th class="col-md-1">Visitor Mobile No</th>
									<th class="col-md-1">Exhibitor Email Id</th>
								...
								<c:forEach items="${spinWithVisitorInfo}"
									...
									<tr>
										...
										<td class="col-md-1"><div>
												<a
													href="${pageContext.request.contextPath}/empDetail/${spinWithVisitorInfo.empId}"
												...
												<a
													href="${pageContext.request.contextPath}/deleteEmp/${spinWithVisitorInfo.empId}"
